...
import 'package:cake_wallet/themes/amoled_dark_theme.dart';
...
class ThemeList {
  ...
  static final moneroLightTheme = MoneroLightTheme(raw: 3);
  static final moneroDarkTheme = MoneroDarkTheme(raw: 4);
  static final amoledDarkTheme = AmoledDarkTheme(raw: 5);
